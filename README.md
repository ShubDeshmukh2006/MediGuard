# 💊MediGuard — Medicine Combination Checker


MediGuard is a **Django-based medicine combination checker** that allows users to search for medicines and check whether a combination has a known interaction according to the application's curated database.
